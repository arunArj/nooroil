          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="recipe_name" name="recipe_name" placeholder="Enter recipe name" autocomplete="off"/>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="calories" name="calories" placeholder="Enter calories" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="cooking_time">Cooking time</label>
                  <input type="text" class="form-control" id="cooking_time" name="cooking_time" placeholder="Enter cooking time" autocomplete="off" />
                </div>
                <div class="form-group">
                  <label for="num_of_people">Number Of people</label>
                  <input type="text" class="form-control" id="num_of_people" name="num_of_people" placeholder="Enter number of people" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type='file' name='pdf_upload' id="pdf_upload" accept="application/pdf">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="ar_recipe_name" name="ar_recipe_name" placeholder="Enter recipe name" autocomplete="off"/>
                </div>

                <div class="form-group">
                  <label for="ar_country">Country Arabic</label>
                  <input type="text" class="form-control" id="ar_country" name="ar_country" placeholder="Enter country" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="ar_calories">Calories Arabic</label>
                  <input type="text" class="form-control" id="ar_calories" name="ar_calories" placeholder="Enter calories" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="ar_cooking_time">Cooking time Arabic</label>
                  <input type="text" class="form-control" id="ar_cooking_time" name="ar_cooking_time" placeholder="Enter cooking time" autocomplete="off" />
                </div>
                <div class="form-group">
                  <label for="ar_num_of_people">Number Of people Arabic</label>
                  <input type="text" class="form-control" id="ar_num_of_people" name="ar_num_of_people" placeholder="Enter number of people" autocomplete="off" />
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('recipe/list') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
